...
import com.f3401pal.checkabletreeview.views.Checkable
...
open class Node(
    ...
    @Expose open var detail: NodeDetailMap?,
    ...
    constructor():this("")
    constructor(str:String,isJson:Boolean=false):this(str,detail= NodeDetailMap()){
        if(isJson){
